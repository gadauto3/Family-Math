...
<div id="ViewHistory">
 ...
 <input type="text" id="BAHistory" style="position:absolute; top:115px; left:50px; border:none; background:none; width:30px;" disabled="disabled">
 <input type="text" id="OBPHistory" style="position:absolute; top:115px; left:110px; border:none; background:none; width:30px;" disabled="disabled">
 <input type="text" id="RunsHistory" style="position:absolute; top:115px; left:182px; border:none; background:none; width:30px;" disabled="disabled">
 <input type="text" id="RBIHistory" style="position:absolute; top:115px; left:250px; border:none; background:none; width:30px;" disabled="disabled">
</div>
...
<div id="GraphStats">
 ...
 <?php leftButton("BACK", "switchto('ViewHistory');"); rightButton("NEXT", "start = 0; prevMonth(); switchto('Blank');"); ?>
</div>  
<div id="Blank">
 <img id="Chart" src="" style="position:absolute; top:15px; left:20px;">
 <?php leftButton("BACK", "switchto('GraphStats');"); rightButton("PREV MONTH", "prevMonth();"); ?>
</div>