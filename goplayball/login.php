...
<div id="Front">
 <div class="button" style="top:155px; left:60px;"><div class="right">&nbsp;</div><div class="left">&nbsp;</div><input type="button" class="buttonText" value="NEW ACCOUNT" onclick="switchto('NewAccount');"></input></div>
 <div class="button" style="top:155px; left:190px;"><div class="right">&nbsp;</div><div class="left">&nbsp;</div><input type="button" class="buttonText" value="LOGIN" onclick="switchto('Login');"></input></div>
</div>

<div id="Login">
 <form action="index.php" method="POST">
 <?php leftButton("BACK", "switchto('Front');"); rightButton("NEXT", "if (validateLogin()) { document.forms[0].submit(); };"); ?>
...
<div id="NewAccount">
 <form action="index.php" method="POST">
 <?php leftButton("BACK", "switchto('Front');"); rightButton("SUBMIT", "if (validateNewAccount()) { document.forms[1].submit(); };"); ?>
