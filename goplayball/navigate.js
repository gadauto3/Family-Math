...
function CHANGE()
{
    ...
    else
    {
		...
		document.getElementById("AlertText").innerHTML = "Saving data...";
...
{	
	...
	var dateInd = document.getElementById("MLBNewDate").value.lastIndexOf("-");
	var sendText =  	"date=" + document.getElementById("VerifyDate").value.substr(dateInd+1) + "-" + document.getElementById("VerifyDate").value.substr(0, dateInd)
...
function changeChartParams(){
	document.getElementById('Chart').src = formChartURL();
}
...
function saveMLB()
{
	...
	var dateInd = document.getElementById("MLBNewDate").value.lastIndexOf("-");
	var sendText =  	"date=" + document.getElementById("MLBNewDate").value.substr(dateInd+1) + "-" + document.getElementById("MLBNewDate").value.substr(0, dateInd)
...
function formChartURL() {
	return 'chart.php?start=' + start + '&stat=' + document.getElementById('GraphSelect').value + '&playerid=' + document.getElementById('GraphMLBSelect').value;
}